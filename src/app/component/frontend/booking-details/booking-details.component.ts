...
export class BookingDetailsComponent {
  ...
  patchContactForm(){
      ...
      this._frontend.getUserById(data).subscribe((res:any)=>{
        ...
        this.userForm.patchValue({
          ...
          last_name: res.result.first_name,
  ...
  onCouponCode(){
    if(this.couponCode){
      console.log("working ", this.couponCode);
    }
  }
...
onPayHotel(){
  if(this.isLogin == true){
    ...
    Swal.fire({
      position: 'top',
      title: 'Login/Sign Up!',
      text: 'Please Sign in or Sign up for booking',
      icon: 'info',
